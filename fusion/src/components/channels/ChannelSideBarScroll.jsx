...
export const ChannelSideBarScroll = () => {
  return (
    <div
      className="channels-side-bar-scroll-bar"
      ...
      <ul aria-label="Channels" className="channel-sidebar-scroll-ul-content">
        ...
        <div className="channel-sidebar-scroll-icon-wrapper">
          <div className="channel-sidebar-scroll-content">
            <div
              className="channel-sidebar-scroll-main-content"
              role="listitem"
              data-list-item-id="channels___home-tab-662267976984297473"
              tabIndex={-1}
            >
          ...
          <div className="channel-sidebar-scroll-icon-wrapper">
            ...
            <div className="channel-sidebar-scroll-content">
              <div
                className="channel-sidebar-scroll-main-content"
                role="listitem"
                data-list-item-id="channels___upcoming-events-662267976984297473"
                tabIndex={-1}
              >
                <div className="channel-sidebar-scroll-icon-container">
                  <EventCalenderIcon />
                ...
                <div
                  className="channel-sidebar-numberBadge"
                  style={{ width: 16 }}
                >
                  2
                </div>
          ...
          <div className="channel-sidebar-scroll-icon-wrapper">
            <div className="channel-sidebar-scroll-content">
              ...
              >
                ...
                <div className="channel-sidebar-scroll-icon-text">
                  Channels &amp; Roles
                </div>
              </div>
            </div>
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default-title"
          data-dnd-name="info"
          draggable="true"
        >
          <div className="channel-sidebar-scroll-icon-wrapper-title collapsed-2KOacR clickable-2AoIYN">
            <div
              className="channel-sidebar-scroll-main-content-title"
              tabIndex={-1}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default"
          data-dnd-name="announcements"
        >
            ...
            <div className="channel-sidebar-scroll-content">
              ...
              >
                <div
                  ...
                  role="img"
                  className="channel-sidebar-scroll-icon-container"
                >
                  <AnnouncementIcon />
                </div>
                <div
                  className="channel-sidebar-scroll-icon-text channelName-3KPsGw channel-sidebar-title-overflow"
                  aria-hidden="true"
                >
                  announcements
                </div>
              ...
              <div className="channel-scrollbar-children-icon -1MGS9G">
                <div
                  className="channel-scrollbar-children-icon-item"
                  aria-label="Invite to Server"
                  tabIndex={0}
                  role="button"
                >
                  <svg
                    className="channel-scrollbar-children-action-icon"
                    aria-hidden="true"
                    role="img"
                    width={16}
                    height={16}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default"
          data-dnd-name="status"
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
            <div className="channel-scrollbar-unread-sy unreadRelevant-2f-VSK" />
            <div className="channel-sidebar-scroll-content">
              <Link
                to={"/channels/7845466654545"}
                className="channel-sidebar-scroll-main-content"
                tabIndex={-1}
              >
                <div
        ...
        >
          <div className="channel-sidebar-scroll-icon-wrapper-title clickable-2AoIYN">
            ...
            >
              ...
              <h2 className="channel-sidebar-scroll-title-name">
                <div className="channel-sidebar-title-overflow">
                  Newcomer Rooms
                </div>
              </h2>
            </div>
        ...
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
            ...
            <div className="channel-sidebar-scroll-content">
              ...
              >
                <div
                  aria-label="Text (Active Threads)"
                  role="img"
                  className="channel-sidebar-scroll-icon-container"
                >
        ...
        <Link
          ...
          to={"voice/87868676776"}
        >
          <li
            className="channel-sidebar-scroll-icon-wrapper-default"
            data-dnd-name="newbies-15"
          >
            <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
              <div className="channel-scrollbar-unread-sy unreadRelevant-2f-VSK" />
              <div className="channel-sidebar-scroll-content">
                <a
                  href="/channels/662267976984297473/981697600023560262"
                  role="link"
                  className="channel-sidebar-scroll-main-content"
                  data-list-item-id="channels___981697600023560262"
                  tabIndex={-1}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default-title"
          data-dnd-name="newcomer rooms 2"
          draggable="true"
        >
          <div className="channel-sidebar-scroll-icon-wrapper-title clickable-2AoIYN">
            <div
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default"
          data-dnd-name="newbies-75"
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
            <div className="channel-scrollbar-unread-sy unreadRelevant-2f-VSK" />
            <div className="channel-sidebar-scroll-content">
              <Link
                to={"/channels/1000898545/video/7678768"}
                className="channel-sidebar-scroll-main-content"
                tabIndex={-1}
              >
                <div
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default selected-2TbFuo"
          data-dnd-name="discussion"
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeSelected-3DmyhH">
            <div className="channel-sidebar-scroll-content">
              <a
                href="/channels/662267976984297473/938713143759216720"
                role="link"
                className="channel-sidebar-scroll-main-content"
                data-list-item-id="channels___938713143759216720"
                tabIndex={-1}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default"
          data-dnd-name="philosophy"
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
            <div className="channel-scrollbar-unread-sy unreadRelevant-2f-VSK" />
            <div className="channel-sidebar-scroll-content">
              <a
                href="/channels/662267976984297473/989270503925616680"
                role="link"
                className="channel-sidebar-scroll-main-content"
                data-list-item-id="channels___989270503925616680"
                tabIndex={-1}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default"
          data-dnd-name="prompt-chat"
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
            <div className="channel-scrollbar-unread-sy unreadRelevant-2f-VSK" />
            <div className="channel-sidebar-scroll-content">
              <a
                href="/channels/662267976984297473/992207085146222713"
                role="link"
                className="channel-sidebar-scroll-main-content"
                data-list-item-id="channels___992207085146222713"
                tabIndex={-1}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default"
          data-dnd-name="off-topic"
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
            <div className="channel-scrollbar-unread-sy unreadRelevant-2f-VSK" />
            <div className="channel-sidebar-scroll-content">
              <a
                href="/channels/662267976984297473/942201389805879366"
                role="link"
                className="channel-sidebar-scroll-main-content"
                data-list-item-id="channels___942201389805879366"
                tabIndex={-1}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default"
          data-dnd-name="ideas-and-features"
        >
          <div className="channel-sidebar-scroll-icon-wrapper wrapper-NhbLHG modeUnread-3Cxepe">
            <div className="channel-scrollbar-unread-sy unreadRelevant-2f-VSK" />
            <div className="channel-sidebar-scroll-content">
              <a
                href="/channels/662267976984297473/989270517401911316"
                role="link"
                className="channel-sidebar-scroll-main-content"
                data-list-item-id="channels___989270517401911316"
                tabIndex={-1}
        ...
        <li
          className="channel-sidebar-scroll-icon-wrapper-default-title"
          data-dnd-name="Community Forums"
          draggable="true"
        >
          <div className="channel-sidebar-scroll-icon-wrapper-title clickable-2AoIYN">
            <div
