      ...
      <div className="chat-content-wrapper">
        <main className="chat-content" aria-label="philosophy (channel)">
          ...
          <div className="chat-message-wrapper">
            <MessageNotification since={"10:30 AM"} count={"50"} />
            <div
            ...
            >
              <div className="scrollerContent-2SW0kQ content-yjf30S">
                <ol
                  ...
                  aria-label="Messages in philosophy"
                  role="list"
                ...
                >
                  <span
                    ...
                    aria-hidden="true"
                  >
                    Use the up and down arrow keys to navigate between messages
                    quickly. New messages will be added to the bottom of the
                  ...
                  <Message
                    ...
                    replayAvatar={
                      "https://cdn.discordapp.com/avatars/186675009706524673/2dbe296ba70d43ac9d06fcec1f2d24ce.webp?size=32"
                    }
