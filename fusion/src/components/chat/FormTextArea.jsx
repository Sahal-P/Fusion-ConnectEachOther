    ...
    <div className="scrollableContainer-15eg7h webkit-QgSAqd">
      <div className="inner-NQg18Y sansAttachButton-1ERHue">
        ...
        <div className="textArea-2CLwUE textAreaSlate-9-y-k2 slateContainer-3x9zil">
          <div>
            <input placeholder={"Message #newbies-45"} value={message} onChange={HandleMessage} type="text" className="markup-eYLPri editor-H2NA06 slateTextArea-27tjG0 fontSize16Padding-XoMpjI" style={{
                position: "relative",
                outline: "none",
                background:"none",
                border:"none",
