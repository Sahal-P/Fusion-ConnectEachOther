const ImageDivAlternative = () => {
  return (
    <li
      id="chat-messages-989270503925616680-1102089474554470458"
      className="chat-messageListItem"
      aria-setsize={-1}
    >
      <div
        className="message-2CShn3 cozyMessage-1DWF9U wrapper-30-Nkg cozy-VmLDNB zalgo-26OfGz"
        role="article"
        data-list-item-id="chat-messages___chat-messages-989270503925616680-1102089474554470458"
        tabIndex={-1}
        aria-setsize={-1}
        aria-roledescription="Message"
        aria-labelledby="message-username-1102088918486237224 uid_1 message-content-1102089474554470458 message-accessories-1102089474554470458 uid_2 message-timestamp-1102089474554470458"
        aria-describedby="uid_3 message-reactions-1102089474554470458"
      >
        <div className="contents-2MsGLg">
          <span className="latin24CompactTimeStamp-2pXUBq timestamp-p1Df1m timestampVisibleOnHover-9PEuZS alt-1dvXnH">
            <time
              aria-label="Today at 10:00 AM"
              id="message-timestamp-1102089474554470458"
              dateTime="2023-04-30T04:30:06.566Z"
            >
          ...
          <div
            id="message-content-1102089474554470458"
            className="markup-eYLPri messageContent-2t3eCI"
          >
            Decided to go crazy and see what Marx was actually critiquing — you
            can tell which book’s seen more use lol
          </div>
        </div>
        <div
          id="message-accessories-1102089474554470458"
        ...
        >
              ...
              <div className="messageAttachment-CZp8Iv messageAttachmentNoJustify-lIzP9c messageAttachmentMediaMosaic-2ic1yt hideOverflow-bsO1Md">
                <div className="imageContent-3Av-9c embedWrapper-1MtIDg attachmentContentContainer-3WAhvQ attachmentContentItem-UKeiCx">
                  <div className="imageContainer-10XenG">
                    <div
                      className="imageWrapper-oMkQl4 imageZoom-3yLCXY clickable-LksVCf lazyImgContainer-3k3gRy"
                      style={{
                        display: "block",
                        maxHeight: "inherit",
                        margin: "auto",
                    ...
                    >
                      <a
                        ...
                        href="https://cdn.discordapp.com/attachments/989270503925616680/1102089474046951544/8D6CAD63-D0B7-4487-A104-FF6B80DFA017.jpg"
                        data-role="img"
                      />
                      <div
                        className="clickableWrapper-2WTAkL"
                        tabIndex={0}
                        aria-label="Image"
                      ...
                      >
                        <img
                          className="lazyImg-ewiNCh"
                          alt="Image"
                          src="https://media.discordapp.net/attachments/989270503925616680/1102089474046951544/8D6CAD63-D0B7-4487-A104-FF6B80DFA017.jpg?width=934&height=700"
                          style={{
                            display: "block",
                            objectFit: "cover",
                            minWidth: "100%",
          ...
          <div
            className="reactions-3ryImn"
            role="group"
            id="message-reactions-1102089474554470458"
          >
            <div />
            <span className="">
              <div>
                <div className="reaction-3vwAF2" style={{ opacity: 1 }}>
                  <div
                    className="reactionInner-YJjOtT"
                    aria-expanded="false"
                    aria-disabled="false"
                    aria-label="joy, 1 reaction, press to react"
                    aria-pressed="false"
                    role="button"
                    tabIndex={0}
                  >
                    ...
                    <div>
                      <img
                        src="/assets/6201503f3aa918470a2190b36d1e196f.svg"
                        alt="😂"
                        draggable="false"
                        className="emoji"
                        data-type="emoji"
                    ...
                    <div
                      className="reactionCount-26U4As"
                      style={{ minWidth: 9 }}
                    >
                      1
                    </div>
            ...
            <div aria-label="Add Reaction">
              <div
                className="reactionBtn-3I19bq"
                aria-expanded="false"
                role="button"
                tabIndex={0}
              >
                <svg
                  className="icon-1q31jb"
                  aria-hidden="true"
                  role="img"
                  width={18}
                  height={18}
...
export default ImageDivAlternative;
