...
export const ChatHeaderTitle = () => {
  return (
    <section
    className="chat-base-titile-conatiner"
    aria-label="Channel header"
  >
    <div className="chat-titile-children">
      <div className="chat-title-icon-wrapper">
        <svg
          width={24}
          height={24}
          viewBox="0 0 24 24"
          className="chat-title-icon2x"
          x={0}
          y={0}
          aria-hidden="true"
          role="img"
      ...
      <span className="chat-hidden-usually">Text Channel</span>
      <div className="chat-title-wrapper">
        <h1
          className="chat-title-heading-h1"
          data-text-variant="heading-md/semibold"
        >
          <span className="chat-hidden-usually">Midjourney:</span> philosophy
        </h1>
      </div>
      <div className="chat-title-divider" />
      <div className="chat-title-topic-expandable">
        <div
          className="chat-title-topic-click-target"
          aria-label="Open Channel Topic"
          role="button"
          tabIndex={0}
        />
        A channel focused on philosophical or abstract discussion around ai,
        image generation, imagination, and art
      </div>
    </div>
    <div className="chat-title-toolbar">
      <div
        className="chat-title-icon-1e chat-title-icon-wrapper "
        role="button"
        aria-label="Threads"
        aria-expanded="false"
        tabIndex={0}
      ...
      <div
        className="chat-title-icon-wrapper"
        role="button"
      ...
      <div
        className="chat-title-icon-wrapper clickable-ZD7xvu"
        role="button"
        aria-label="Pinned Messages"
        aria-expanded="false"
        tabIndex={0}
      >
        <svg width={24} height={24} className="svg-contain-paint" viewBox="0 0 24 24">
          <foreignObject
            x={0}
            y={0}
            width={24}
            height={24}
            overflow="visible"
            mask="url(#svg-mask-header-bar-badge)"
          >
            <svg
              x={0}
              y={0}
      ...
      <div className="chat-title-search ">
        <div className="chat-title-search2">
          <div className="chat-title-search-bar">
            <div className="DraftEditor-root">
            {/* focused-1xh-wG open-1F8u2c */}
              
              <input className="chat-title-search-bar" type="text" placeholder='Search' />
            </div>
            <div
              className="chat-title-search-icon"
              tabIndex={-1}
              aria-hidden="true"
              aria-label="Clear search"
              role="button"
            >
              <div className="chat-title-search-icon-container">
                <svg
                  className="chat-title-search-icon-svg icon-svg-visible"
                  aria-hidden="true"
                  role="img"
                  width={24}
                  height={24}
                ...
                <svg
                  aria-hidden="true"
                  role="img"
                  className="chat-title-search-icon-svg"
                  width={24}
                  height={24}
                  viewBox="0 0 24 24"
                >
