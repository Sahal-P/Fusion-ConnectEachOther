  ...
  return (
    <form className="form-channel-text-area">
            <div className="channelTextArea-1FufC0 channelTextArea-1VQBuV channelTextAreaDisabled-1p2fQv">
                <div className="channel-text-scrollable-container">
                    <div className="chat-channel-text-area-disabled">
                        <div className="chat-channel-text-area-disabled-slate">
                            <div>
                                <div className="chat-channel-text-placeholder" aria-hidden="true">
                                    You do not have permission to send messages in this channel.
                                </div>
                                <div spellCheck="true" aria-haspopup="listbox" aria-invalid="false" aria-autocomplete="list" className="markup-eYLPri editor-H2NA06 slateTextArea-27tjG0 fontSize16Padding-XoMpjI" autoCorrect="off" data-can-focus="false" aria-label="You do not have permission to send messages in this channel." aria-multiline="true" data-slate-editor="true" data-slate-node="value" contentEditable="false"
                                    zindex={-1}
                                    style={
                                        {
                                            position: "relative",
                ...
                <div className="container-1ZA19X hidden-tnoHf9 stickerIconOffset-2zxofV"
                    tabIndex={-1}
                    aria-hidden="true"
                    role="button"
                    style={
                    ...
                    <div className="stickerResults-cD_yeI"
                        tabIndex={-1}
                        role="list"
                    ...
                    <div className="bottomInformationTextContainer-3xmddX">
                        ...
                        <div className="bottomInformationLayout-3pAQvD">
                            <div className="defaultColor-1EVLSt text-sm-normal-AEQz4v descriptionText-yl6pN6" data-text-variant="text-sm/normal"
                                style={
                                    {maxWidth: 120}
                            }>
                            ...
                            <div className="" role="button"
                                tabIndex={0}>
                                <svg aria-label="Don't show again" aria-hidden="false" role="img" className="closeIcon-14ZT1N"
                                    width={24}
                                    height={24}
                                    viewBox="0 0 24 24">
