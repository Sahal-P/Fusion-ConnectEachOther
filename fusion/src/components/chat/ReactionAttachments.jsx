export const ReactionAttachments = () => {
    return (
        <div className="reactions-3ryImn" role="group" id="message-reactions-1102096781636018307">
            <div/>
            <span className="">
                <div>
                    <div className="reaction-3vwAF2"
                        style={
                            {opacity: 1}
                    }>
                        <div className="reactionInner-YJjOtT" aria-expanded="false" aria-disabled="false" aria-label="100, 1 reaction, press to react" aria-pressed="false" role="button"
                            tabIndex={0}>
                            <div className=""/>
                            <div>
                                <img src="/assets/db009c8fa13d0f303df266e9d42c8e30.svg" alt="💯" draggable="false" className="emoji" data-type="emoji" data-name="💯"/>
                            </div>
                            <div className="reactionCount-26U4As"
                                style={
                                    {minWidth: 9}
                            }>
                                1
