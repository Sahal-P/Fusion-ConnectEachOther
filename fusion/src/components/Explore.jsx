...
const Explore = () => {
    ...
    const fetchData = async  (value) =>{
        try{
            const res = await axios.get(`http://localhost:8000/search?prefix=${value}`)
            if(res.status === 204 ){
                setResults([])
                return
            }
    ...
    return (
        <div className="Explorewindow">
            ...
            <div className="scroller_base">
                        ...
                        <div className="explore_search_box">
                            <div className="search_field">
                                ...
                                <div className="search-bar-container">
                                    ...
                                    <input type="text" placeholder="Search" value={input} onChange={onSearch}/>
                                    <SearchIcon id="explore-search-icon"/>
                                    </div>
                                    <div className="explore-search-result-list">
                                        {results.map((result, id) => {
                                            return <div className="explore-search-results" key={id}>{result}</div>
                                        })}
                                    </div>
                                </div>
                ...
                <div className="featured_h2">
                    Featured communities
                </div>
                <div className="features">
                    <div className="featured_grid">
                        <FeaturedCommunitiesCard title={"Midjourney"}
                        ...
                        <FeaturedCommunitiesCard title={"Genshin Impact Official"}
                        ...
                        <FeaturedCommunitiesCard title={"OpenAI"}
                            text={"A space for developers and enthusiasts to collaborate and share creations built with OpenAI's powerful models."}
                            online={"320,233 Online"}
                            members={"1,320,233 Members"}
                            avatar={card_avatar3}
                            bg_image={card_background3}/>
                        <FeaturedCommunitiesCard title={"VALORANT"}
                        ...
                        <FeaturedCommunitiesCard title={"MINECRAFT"}
                            text={"The official Minecraft Discord. Find the latest news and talk about the game!"}
