      ...
      <div className="loaded_card">
        <div className="card_header">
          <div className="card_background">
            <img src={props.bg_image} className="card_image" alt="" />
          </div>
                ...
                <div className="iconMask">
                  <svg width={40} height={40} viewBox="0 0 40 40">
                    <foreignObject
                      ...
                      mask="url(#svg-mask-squircle)"
                    >
                      <img src={props.avatar} alt="" className="image_avatar" />
                    </foreignObject>
                  </svg>
                </div>
              </foreignObject>
        ...
        <div className="card_info">
          <div className="card_info_title">
            ...
            <h3 className="card_info_title_text">{props.title} </h3>
          </div>
          ...
          <div className="card_member_info">
            <div className="card_member_count">
              ...
              <div className="card_memeber_text">{props.online} </div>
            </div>
            <div className="card_member_count">
              <div className="dot_members" />
              <div className="card_memeber_text">{props.members} </div>
            </div>
          </div>
        </div>
      </div>
