...
const VideoChat = () => {
  ...
  useEffect(() => {
    ...
    //   // Create a new ref for the new user's video element
    //   const newVideoRef = React.createRef();
    //   remoteVideoRefs.current.push(newVideoRef);
    // };
    ...
    //   // Remove the corresponding ref for the user's video element
    //   remoteVideoRefs.current = remoteVideoRefs.current.filter(
    //     (_, index) => index !== remoteUsers.indexOf(user)
    //   );
    // };
    ...
    _pc.onicecandidate = (e) => {
      if (e.candidate) {
        ...
        if (socket) {
          // Add a null check for the socket variable
  ...
  // const createRemoteUserComponent = () => {
  //   return remoteUsers.map((user, index) => (
  //     <VideoScreenContainer
  //       key={index}
  //       reference={remoteVideoRefs.current[index]}
  //       user={user}
  //     />
  //   ));
  // }
                ...
                >
                  ...
                  >
                    <div className="row-jreWvj">
                      <VideoScreenContainer
                        refrence={localVideoRef}
                        user={"user"}
                      />
                      <VideoScreenContainer
                        refrence={remoteVideoRef}
                        user={"remote"}
                      />
                      {/* {createRemoteUserComponent()} */}
