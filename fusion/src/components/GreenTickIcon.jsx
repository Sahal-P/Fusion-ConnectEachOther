...
export const GreenTickIcon = () => {
  return (
    <div className="card_info_title_icon"
                            style={
                                {
                                    width: 16,
                                    height: 16
                            ...
                            <svg aria-label="Verified" className="card_info_flowerStar" aria-hidden="false" role="img"
                                width={16}
                                height={16}
                                viewBox="0 0 16 15.2">
                            ...
                            <div className="card_info_child_icon_container">
                                <svg className="card_info_icon-" aria-hidden="true" role="img"
                                    width={16}
                                    height={16}
                                    viewBox="0 0 16 15.2">
