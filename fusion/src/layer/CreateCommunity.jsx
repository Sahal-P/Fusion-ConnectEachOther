...
const CreateCommunity = () => {
    const state = useSelector((state)=>state.createCommunity.value)
  const dispatch = useDispatch()
  const PopOutCommunityCreate = () => {
    dispatch(CreateCommunityActions.setCommunityPop(false)) 
  }
  return (
    <>
    <div style={{display: state ? 'block' : 'none'}}>
      <div onClick={PopOutCommunityCreate}
...
/>
  ...
  <div className="theme-dark">
    ...
    >
      <div
        className="root-1CAIjD small-2xUY-3 fullscreenOnMobile-2971EC rootWithShadow-2hdL2J"
        style={{ opacity: 1, transform: "scale(1)" }}
      >
        <div className="container-1Lk8p7">
          <div
            style={{
              position: "relative",
              width: 440,
          ...
          >
            ...
            >
              <div
                className="flex-2S1XBF flex-3BkGQD vertical-3aLnqW flex-3BkGQD directionColumn-3pi1nm justifyStart-2Mwniq alignCenter-14kD11 noWrap-hBpHBz header-1ffhsl header-1AP5SJ"
                id=":r2:"
                style={{ flex: "0 0 auto" }}
              >
                <h1
                  className="defaultColor-1EVLSt heading-xl-semibold-3E1dYv defaultColor-1GKx81 title-2Giw-4"
                  data-text-variant="heading-xl/semibold"
                >
                  Customize your server
                </h1>
                <div
                  className="text-md-normal-2rFCH3 subtitle-bIoUVX"
                ...
                <button
                  aria-label="Close"
                  type="button"
                  className="closeButton-1diDVp close-A4ZfTI button-ejjZWC lookBlank-FgPMy6 colorBrand-2M3O3N grow-2T4nbg"
                >
              ...
              <div
                className="content-1OG56Q createGuild-2m1V10 thin-RnSY0a scrollerBase-1Pkza4"
                dir="ltr"
                style={{ overflow: "hidden scroll", paddingRight: 8 }}
              >
                <div className="uploadIcon-2wV7s_">
                  <div className="iconContainer-GFfNaA desaturate-_Twf3u">
                ...
                <form>
                  <div className="nameInput-ph8KMi">
                    <label
                      className="label-7akf7- eyebrow-2wJAoF defaultColor-3Olr-9 defaultMarginlabel-26Urq5"
                      htmlFor="uid_59"
                    >
                      Server Name
                    </label>
                    <div className="inputWrapper-2K8ds1">
                      <input
                        className="inputDefault-Ciwd-S input-3O04eu"
                        type="text"
                        maxLength={100}
                        id="uid_59"
                        name=""
                        placeholder=""
                        aria-labelledby=":r3:"
                        defaultValue="sahal's server"
                      />
                    </div>
                  </div>
                  <div
                    className="text-xs-normal-3O7EaX guidelines-FvqqF2"
              ...
              <div
                className="flex-2S1XBF flex-3BkGQD horizontalReverse-60Katr horizontalReverse-2QssvL flex-3BkGQD directionRowReverse-HZatnx justifyBetween-wAERV6 alignStretch-Uwowzr noWrap-hBpHBz footer-IubaaS footerSeparator-3U8YsT"
                style={{ flex: "0 0 auto" }}
              >
                <button
                  type="button"
                ...
                >
                  <div className="contents-3NembX">Create</div>
                </button>
                <button
                  type="button"
                  className="button-ejjZWC lookBlank-FgPMy6 colorBrand-2M3O3N sizeMin-3Yqxk5 grow-2T4nbg"
                >
                  <div className="contents-3NembX">Back</div>
                </button>
              </div>
            </div>
          </div>
